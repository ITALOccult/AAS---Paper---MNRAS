...
orbital periods \citep{HairerLubichWanner2006, Lu2024trace, Ye2025}. However, 
standard symplectic integrators use a fixed time step, which is computationally
...
Hamiltonians \cite{Wang2024tts, Wu2024adaptive}.
...
\end{table*}
High-accuracy non-symplectic alternatives---\textsc{ias15}
\citep{ReinSpiegel2015} and \textsc{heyoka}
\citep{Biscani2021heyoka}---are included as reference
integrators in Section~\ref{sec:comparison}.
